...
- Hover InnerTune on the Windows taskbar for Previous, Play/Pause, and Next; the DJ Cat icon itself can animate with wide hand movement and a translucent equalizer rendered behind it.
